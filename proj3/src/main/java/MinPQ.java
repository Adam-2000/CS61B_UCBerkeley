...
public class MinPQ<Key> implements Iterable<Key> {
    ...
    public interface HeapHandler {
        void changeHeapId(int i);
    }
    ...
    ***************************************************************************/
    ...
    public void setHasHandle(boolean hasHandle1) {
        hasHandle = hasHandle1;
        if (hasHandle) {
            for (int i = 1; i <= n; i++) {
                ((HeapHandler) pq[i]).changeHeapId(i);
            }
        }
    }
    private void updateHeapId(int i) {
        if (hasHandle) {
            ((HeapHandler) pq[i]).changeHeapId(i);
        }
    }
